...
public class Application {
	...
	public static void main(String[] args) throws ParseException {
		...
		tempoFinal = System.currentTimeMillis();
		gerarCsv.writeInFile(insertionMortes, "resultados/insertion_ordena.csv");
		System.out.println("Tempo de execução : " + (tempoFinal - tempoInicial) + " ms");
		...
		tempoFinal = System.currentTimeMillis();
		gerarCsv.writeInFile(selectionMortes, "resultados/selection_ordena.csv"); 
		System.out.println("Tempo de execução : " + (tempoFinal - tempoInicial) + " ms");
		...
		tempoFinal = System.currentTimeMillis();
		gerarCsv.writeInFile(mergeMortes, "resultados/merge_ordena.csv");
		System.out.println("Tempo de execução : " + (tempoFinal - tempoInicial) + " ms");
		...
		tempoFinal = System.currentTimeMillis();
		gerarCsv.writeInFile(quickMortes, "resultados/quick_ordena.csv");
		System.out.println("Tempo de execução : " + (tempoFinal - tempoInicial) + " ms");
		...
		tempoFinal = System.currentTimeMillis();
		gerarCsv.writeInFile(medianaMortes, "resultados/medianaDeTrês_ordena.csv");
		System.out.println("Tempo de execução : " + (tempoFinal - tempoInicial) + " ms");
		...
		tempoFinal = System.currentTimeMillis();
		gerarCsv.writeInFile(heapifyMortes, "resultados/Heapify_ordena.csv");
		System.out.println("Tempo de execução : " + (tempoFinal - tempoInicial) + " ms");
		tempoInicial = System.currentTimeMillis();
